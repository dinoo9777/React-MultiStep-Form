...
const StepTwo = () => {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white p-6">
      <h2 className="text-3xl font-semibold mb-1 text-center">Let's set up a home for all your work</h2>
      <p className="text-sm text-gray-500 mb-6 text-center">You can always create another workspace later.</p>
        <div className="max-w-xs mx-auto">
            ...
            <div className="mb-6">
                ...
                <input
                    ...
                    onChange={(e) => updateFormData({ workspaceUrl: e.target.value })}
